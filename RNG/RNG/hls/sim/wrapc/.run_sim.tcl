...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "RNG.autotvin.dat"
	set constFileTvOut       "RNG.autotvout.dat"
	set constFileHdlTvIn     "RNG.autohdltvin.dat"
	set constFileHdlTvOut    "RNG.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
