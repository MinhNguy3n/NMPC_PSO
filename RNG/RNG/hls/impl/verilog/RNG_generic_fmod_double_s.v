...
module RNG_generic_fmod_double_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] ret_5_reg_322;
wire   [51:0] fz_sig_fu_113_p1;
reg   [51:0] fz_sig_reg_328;
wire   [0:0] isF_e_x_fu_117_p2;
reg   [0:0] isF_e_x_reg_333;
wire   [0:0] isyBx_e_fu_123_p2;
reg   [0:0] isyBx_e_reg_337;
wire   [0:0] or_ln267_fu_141_p2;
reg   [0:0] or_ln267_reg_341;
wire   [0:0] or_ln271_fu_153_p2;
reg   [0:0] or_ln271_reg_345;
wire   [52:0] ap_mx_fu_169_p3;
reg   [52:0] ap_mx_reg_349;
...
reg   [0:0] icmp_ln319_reg_372;
wire    ap_CS_fsm_state5;
wire   [5:0] trunc_ln324_fu_219_p1;
reg   [5:0] trunc_ln324_reg_376;
wire   [6:0] add_ln325_fu_227_p2;
reg   [6:0] add_ln325_reg_382;
wire   [51:0] ap_mx_2_fu_263_p3;
reg   [51:0] ap_mx_2_reg_387;
wire    ap_CS_fsm_state6;
wire   [63:0] t_4_fu_300_p3;
wire    ap_CS_fsm_state8;
wire   [63:0] t_fu_308_p3;
...
wire  signed [31:0] sext_ln325_fu_247_p1;
wire   [53:0] zext_ln325_fu_250_p1;
wire   [53:0] shl_ln325_fu_254_p2;
wire   [0:0] icmp_ln325_fu_233_p2;
wire   [51:0] trunc_ln325_1_fu_238_p4;
wire   [51:0] empty_fu_259_p1;
wire   [5:0] sub_ln327_fu_271_p2;
wire  signed [10:0] sext_ln327_fu_276_p1;
wire   [10:0] fz_exp_1_fu_280_p2;
wire   [63:0] bitcast_ln497_fu_296_p1;
...
RNG_generic_fmod_double_Pipeline_1 grp_generic_fmod_double_Pipeline_1_fu_87(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln319_reg_372 == 1'd0) & (or_ln271_reg_345 == 1'd1) & (or_ln267_reg_341 == 1'd1) & (isyBx_e_reg_337 == 1'd0) & (isF_e_x_reg_333 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ap_mx_reg_349[51 : 0] <= ap_mx_fu_169_p3[51 : 0];
...
always @ (*) begin
    if (((icmp_ln319_reg_372 == 1'd0) & (or_ln271_reg_345 == 1'd1) & (or_ln267_reg_341 == 1'd1) & (isyBx_e_reg_337 == 1'd0) & (isF_e_x_reg_333 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((icmp_ln319_fu_205_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
assign ap_mx_2_fu_263_p3 = ((icmp_ln325_fu_233_p2[0:0] == 1'b1) ? trunc_ln325_1_fu_238_p4 : empty_fu_259_p1);

assign ap_mx_fu_169_p3 = {{1'd1}, {fz_sig_fu_113_p1}};

assign bitcast_ln497_fu_296_p1 = ap_phi_mux_retval_1_in_phi_fu_73_p12;

assign empty_fu_259_p1 = shl_ln325_fu_254_p2[51:0];

assign fz_exp_1_fu_280_p2 = ($signed(sext_ln327_fu_276_p1) + $signed(11'd1023));
...
assign grp_fu_94_p3 = ret_5_reg_322[32'd63];

assign grp_generic_fmod_double_Pipeline_1_fu_87_ap_start = grp_generic_fmod_double_Pipeline_1_fu_87_ap_start_reg;

assign icmp_ln267_1_fu_135_p2 = ((fz_sig_fu_113_p1 > 52'd4503599623176191) ? 1'b1 : 1'b0);

assign icmp_ln267_fu_129_p2 = ((fz_exp_fu_105_p3 != 11'd1053) ? 1'b1 : 1'b0);

assign icmp_ln271_fu_147_p2 = ((fz_sig_fu_113_p1 != 52'd4503599623176192) ? 1'b1 : 1'b0);

assign icmp_ln319_fu_205_p2 = ((grp_generic_fmod_double_Pipeline_1_fu_87_r_sh_1_out == 54'd0) ? 1'b1 : 1'b0);

assign icmp_ln325_fu_233_p2 = ((trunc_ln324_reg_376 == 6'd0) ? 1'b1 : 1'b0);

assign isF_e_x_fu_117_p2 = ((fz_exp_fu_105_p3 == 11'd2047) ? 1'b1 : 1'b0);

assign isyBx_e_fu_123_p2 = ((fz_exp_fu_105_p3 < 11'd1053) ? 1'b1 : 1'b0);

assign n_fu_178_p2 = ($signed(fz_exp_cast_fu_159_p4) + $signed(10'd995));
...
assign sext_ln325_fu_247_p1 = $signed(add_ln325_reg_382);

assign sext_ln327_fu_276_p1 = $signed(sub_ln327_fu_271_p2);

assign shl_ln325_fu_254_p2 = grp_generic_fmod_double_Pipeline_1_fu_87_r_sh_1_out << zext_ln325_fu_250_p1;

assign sub_ln327_fu_271_p2 = (6'd31 - trunc_ln324_reg_376);

assign t_2_fu_185_p4 = {{{grp_fu_94_p3}, {11'd1053}}, {fz_sig_reg_328}};

assign t_3_fu_194_p3 = {{grp_fu_94_p3}, {63'd0}};

assign t_4_fu_300_p3 = {{grp_fu_94_p3}, {63'd0}};

assign t_5_fu_286_p4 = {{{grp_fu_94_p3}, {fz_exp_1_fu_280_p2}}, {ap_mx_2_reg_387}};

assign t_fu_308_p3 = {{grp_fu_94_p3}, {63'd9223372036854775807}};

assign trunc_ln324_1_fu_223_p1 = tmp_5_fu_211_p3[6:0];

assign trunc_ln324_fu_219_p1 = tmp_5_fu_211_p3[5:0];

assign trunc_ln325_1_fu_238_p4 = {{grp_generic_fmod_double_Pipeline_1_fu_87_r_sh_1_out[52:1]}};

assign zext_ln325_fu_250_p1 = $unsigned(sext_ln325_fu_247_p1);

always @ (posedge ap_clk) begin
    ap_mx_reg_349[52] <= 1'b1;
end

endmodule //RNG_generic_fmod_double_s
