...
#define AUTOTB_TVOUT_seedi "../tv/cdatafile/c.RNG.autotvout_seedi.dat"
#define AUTOTB_TVIN_randFloat "../tv/cdatafile/c.RNG.autotvin_randFloat.dat"
#define AUTOTB_TVOUT_randFloat "../tv/cdatafile/c.RNG.autotvout_randFloat.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_randFloat "../tv/rtldatafile/rtl.RNG.autotvout_randFloat.dat"
...
extern "C"
void RNG_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_RNG_hw(void* __xlx_apatb_param_seedi, void* __xlx_apatb_param_randFloat)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_seedi),
#endif
  };
  port0.param = __xlx_apatb_param_seedi;

  static hls::sim::Register port1 {
    .name = "randFloat",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_randFloat),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_randFloat),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_randFloat),
#endif
  };
  port1.param = __xlx_apatb_param_randFloat;
  ...
  try {
    ...
    RNG_hw_stub_wrapper(__xlx_apatb_param_seedi, __xlx_apatb_param_randFloat);
